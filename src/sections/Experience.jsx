const experiences = [
    ...
    role: "High School Education (Class X)",
    company: "Guru Har Rai Academy",
    description:
      "Completed high school education with a 84.2% aggregate, built a strong foundation for higher studies.",
    technologies: ["Mathematics","English", "Hindi", "Science", "Social Studies", "Economics Application"],
    current: false,
  },
  {
    ...
    description:
      "Completed higher secondary education with a 69.4% aggregate, built the academic foundation for engineering studies.",
    technologies: ["Computer Science", "English", "Mathematics", "Physics", "Chemistry"],
    current: false,
  },
  {
